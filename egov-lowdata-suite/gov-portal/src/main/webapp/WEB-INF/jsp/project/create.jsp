...
<head>
    ...
    <title>프로젝트 생성 - LINC 통합관리시스템</title>
...
<main class="main-content">
    <div class="page-title-section">
        <h2 class="page-title">프로젝트 생성</h2>
        <p class="page-subtitle">새로운 국제협력 프로젝트를 등록합니다</p>
    </div>
    
    <div class="form-card">
        <form action="${pageContext.request.contextPath}/projects/create.do" method="post">
            <div class="form-section">
                ...
                <div class="mb-4">
                    ...
                    <input class="form-control" id="tenantId" name="tenantId" 
            ...
            <div class="form-section">
                ...
                <div class="mb-4">
                    ...
                    <textarea class="form-control" id="codebook" name="codebook" 
            ...
            <div class="form-actions">
                ...
                <button class="btn btn-primary-custom" type="submit">
                    <i class="bi bi-check-circle"></i> 프로젝트 등록
                </button>
            </div>
        </form>
    </div>
