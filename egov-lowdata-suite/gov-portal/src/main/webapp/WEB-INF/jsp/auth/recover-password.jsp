...
<head>
    ...
    <title>비밀번호 찾기 - LINC 통합관리시스템</title>
...
<div class="recovery-layout">
    <div class="recovery-card">
        <h1>비밀번호 재설정</h1>
        <p class="subtitle">본인 확인 후 새로운 비밀번호로 재설정할 수 있습니다.</p>
        ...
        <form action="${pageContext.request.contextPath}/auth/recover/password.do" method="post">
            <div class="form-floating mb-3">
                <input type="text"
                       ...
                       required>
                <label for="fullName"><i class="bi bi-person"></i> 이름</label>
            </div>
            ...
            <div class="form-floating mb-3">
                <input type="text"
                       ...
                       required>
                <label for="username"><i class="bi bi-person-badge"></i> 아이디</label>
            </div>

            <div class="verification-field">
                <label for="emailPw">이메일 주소</label>
                <div class="input-group">
                    ...
                    <button type="button"
                            ...
                            data-target-input="emailPw"
                            data-feedback="pwEmailFeedback">
                        인증코드 발송
                    </button>
                </div>
                <div class="input-group mt-2">
                    <input type="text"
                           ...
                           value="${passwordForm.emailVerificationCode}"
                           maxlength="6"
                           required>
                    <button type="button"
                            ...
                            data-verify-type="EMAIL"
                            data-target-input="emailPw"
                            data-code-input="emailPwCode"
                            data-feedback="pwEmailFeedback">
                        인증 확인
                    </button>
                </div>
                <div class="verification-feedback" id="pwEmailFeedback"></div>
            </div>
            ...
            <div class="form-floating mb-3">
                <input type="password"
                       ...
                       minlength="8"
                       required>
                <label for="newPassword"><i class="bi bi-lock"></i> 새 비밀번호</label>
            </div>
            ...
            <button type="submit" class="btn btn-primary">
                <i class="bi bi-arrow-repeat"></i> 비밀번호 재설정
            </button>
        </form>

        <div class="links">
            <div><a href="${pageContext.request.contextPath}/auth/recover/id.do">아이디 찾기</a></div>
