...
| 순서 | 화면 | 설명 멘트 예시 |
|---|---|---|
| 1 | 로그인 | “승인된 담당자만 접근하는 통합 관리 시스템입니다.” |
| 2 | 대시보드 | “전체 프로젝트의 수집 현황과 품질, 예측을 한눈에 봅니다.” |
| 3 | 프로젝트 목록 | “국가·분야별로 운영 중인 협력 사업을 관리합니다.” |
| 4 | 프로젝트 상세 | “각 프로젝트는 ODK와 연동되어 현장 데이터를 자동 수집합니다.” |
| 5 | 프로젝트 통계 | “수집된 180건의 보건 현장 데이터 추이와 품질을 확인합니다.” |
| 6 | ODK Central | “조사원은 이 서버로 모바일 설문 결과를 전송합니다.” |
| 7 | 삭제된 프로젝트 | “종료된 사업도 안전하게 보관·복원할 수 있습니다.” |
